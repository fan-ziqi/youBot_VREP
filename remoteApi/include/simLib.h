...
typedef simInt (__cdecl *ptrSimSetFloatParam)(simInt Param,simFloat floatState);
typedef simInt (__cdecl *ptrSimGetFloatParam)(simInt Param,simFloat* floatState);
...
typedef simInt (__cdecl *ptrSimSetObjectPose)(simInt objectHandle,simInt relativeToObjectHandle,const simFloat* pose);
...
typedef simInt (__cdecl *ptrSimGetJointTargetForce)(simInt jointHandle,simFloat* forceOrTorque);
typedef simInt (__cdecl *ptrSimSetJointTargetForce)(simInt objectHandle,simFloat forceOrTorque,simBool signedValue);
...
typedef simInt (__cdecl *ptrSimBuildPose)(const simFloat* position,const simFloat* eulerAngles,simFloat* pose);
...
typedef simInt (__cdecl *ptrSimAddGraphStream)(simInt graphHandle,const simChar* streamName,const simChar* unitStr,simInt options,const simFloat* color,simFloat cyclicRange);
typedef simInt (__cdecl *ptrSimDestroyGraphCurve)(simInt graphHandle,simInt curveId);
typedef simInt (__cdecl *ptrSimSetGraphStreamTransformation)(simInt graphHandle,simInt streamId,simInt trType,simFloat mult,simFloat off,simInt movingAvgPeriod);
typedef simInt (__cdecl *ptrSimDuplicateGraphCurveToStatic)(simInt graphHandle,simInt curveId,const simChar* curveName);
typedef simInt (__cdecl *ptrSimAddGraphCurve)(simInt graphHandle,const simChar* curveName,simInt dim,const simInt* streamIds,const simFloat* defaultValues,const simChar* unitStr,simInt options,const simFloat* color,simInt curveWidth);
typedef simInt (__cdecl *ptrSimSetGraphStreamValue)(simInt graphHandle,simInt streamId,simFloat value);
...
typedef simInt (__cdecl *ptrSimGetJointVelocity)(simInt jointHandle,simFloat* velocity);
...
typedef simInt (__cdecl *ptrSimSetObjectColor)(simInt objectHandle,simInt index,simInt colorComponent,const simFloat* rgbData);
typedef simInt (__cdecl *ptrSimGetObjectColor)(simInt objectHandle,simInt index,simInt colorComponent,simFloat* rgbData);
...
typedef simFloat (__cdecl *ptrSimGetEngineFloatParam)(simInt paramId,simInt objectHandle,const simVoid* object,simBool* ok);
...
typedef simInt (__cdecl *ptrSimSetEngineFloatParam)(simInt paramId,simInt objectHandle,const simVoid* object,simFloat val);
...
typedef simVoid (__cdecl *ptr_simSetObjectLocalTransformation)(simVoid* object,const simFloat* pos,const simFloat* quat,simFloat simTime);
typedef simVoid (__cdecl *ptr_simDynReportObjectCumulativeTransformation)(simVoid* object,const simFloat* pos,const simFloat* quat,simFloat simTime);
...
typedef simVoid (__cdecl *ptr_simSetShapeDynamicVelocity)(simVoid* shape,const simFloat* linear,const simFloat* angular,simFloat simTime);
...
typedef simVoid (__cdecl *ptr_simSetDynamicMotorReflectedPositionFromDynamicEngine)(simVoid* joint,simFloat pos,simFloat simTime);
typedef simVoid (__cdecl *ptr_simSetJointSphericalTransformation)(simVoid* joint,const simFloat* quat,simFloat simTime);
typedef simVoid (__cdecl *ptr_simAddForceSensorCumulativeForcesAndTorques)(simVoid* forceSensor,const simFloat* force,const simFloat* torque,int totalPassesCount,simFloat simTime);
